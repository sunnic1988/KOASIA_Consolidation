...
/**
 * Servlet implementation class ReportBsServlet
 * 查询balance sheet by company code
 */
public class ReportBsServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		while ((jsonRrequest = reader.readLine()) != null) {
			...
			try {
				...
				JSONArray report = RunIRT.BalanceSheet(companies, currency, Fiscal_Year, Posting_period);
