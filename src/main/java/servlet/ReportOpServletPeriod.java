...
/**
 * Servlet implementation class ReportOpServletPeriod
 * 查询 operating costs by period
 */
public class ReportOpServletPeriod extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		while ((jsonRrequest = reader.readLine()) != null) {
			...
			try {
				...
				JSONArray report = RunIRTbyPeriod.OpeartingCosts(Company, currency, Fiscal_Year);
