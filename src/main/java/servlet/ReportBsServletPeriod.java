...
/**
 * Servlet implementation class ReportBsServletPeriod
 * 查询balance sheet by period
 */
public class ReportBsServletPeriod extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		while ((jsonRrequest = reader.readLine()) != null) {
			...
			try {
				...
				JSONArray report = RunIRTbyPeriod.BalanceSheet(Company, currency, Fiscal_Year);
