...
/**
 * Servlet implementation class ReportOpServlet
 * 查询operating costs by company code
 */
public class ReportOpServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		while ((jsonRrequest = reader.readLine()) != null) {
			...
			try {
				...
				JSONArray report = RunIRT.OpeartingCosts(companies, currency, Fiscal_Year, Posting_period);
