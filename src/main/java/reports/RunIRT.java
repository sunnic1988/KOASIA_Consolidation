...
public class RunIRT {
	...
	public static JSONArray ProfitLoss(String Companies, String currency, String Fiscal_Year, String Posting_period)
			throws SQLException {
		...
		jsonObj = getResult(stmt, companycode, "'REVENUES'", "REVENUES", currency, Fiscal_Year, Posting_period, -1);
		...
		jsonObj = getResult(stmt, companycode, "'Other Capitalized Costs'", "Other Capitalized Costs", currency,
				Fiscal_Year, Posting_period, -1);
		jsonRsArray.add(2, jsonObj);

		jsonObjTBV = getResult(stmt, companycode, "'REVENUES','Change in Stockvalue','Other Capitalized Costs'",
				"Total Business Volume", currency, Fiscal_Year, Posting_period, -1);
		jsonRsArray.add(3, jsonObjTBV);

		jsonObjDM = getResult(stmt, companycode, "'Direct Material'", "Direct Material", currency, Fiscal_Year,
				Posting_period, 1);
		...
		jsonObj = getPLstructure(stmt, companycode, "'002 Direct Labor'", "Direct Labor", currency, Fiscal_Year,
				Posting_period, 1);
		jsonRsArray.add(7, jsonObj);

		jsonObj = getPLstructure(stmt, companycode, "'003 Indirect Labor'", "Indirect Labor", currency, Fiscal_Year,
				Posting_period, 1);
		...
		jsonObj = getPLstructure(stmt, companycode,
				...
				"Other Manufacturing Costs", currency, Fiscal_Year, Posting_period, 1);
		...
		jsonObj = getPLstructure(stmt, companycode,
				...
				"Manufacturing Costs", currency, Fiscal_Year, Posting_period, 1);
		jsonObj = jsonConbinePlus(jsonObj, jsonObjDM, "Manufacturing Costs", companycode);
		jsonRsArray.add(11, jsonObj);

		jsonObjGM = jsonConbine(jsonObjTBV, jsonObj, "Gross Margin", companycode);
		jsonRsArray.add(12, jsonObjGM);

		jsonObj = jsonConbineRatio(jsonObjGM, jsonObjTBV, "in % of Total Business Volume", companycode);
		jsonRsArray.add(13, jsonObj);

		jsonObj = getPLstructure(stmt, companycode, "'007 Engineering'", "Engineering", currency, Fiscal_Year,
				Posting_period, 1);
		jsonRsArray.add(14, jsonObj);

		jsonObj = getPLstructure(stmt, companycode, "'008 Administration'", "Administration", currency, Fiscal_Year,
				Posting_period, 1);
		jsonRsArray.add(15, jsonObj);

		jsonObj = getPLstructure(stmt, companycode, "'009 Sales'", "Sales", currency, Fiscal_Year, Posting_period, 1);
		jsonRsArray.add(16, jsonObj);

		jsonObj = getPLstructure(stmt, companycode, "'007 Engineering','008 Administration','009 Sales'",
				"Overhead Costs", currency, Fiscal_Year, Posting_period, 1);
		jsonRsArray.add(17, jsonObj);

		jsonObjOP = jsonConbine(jsonObjGM, jsonObj, "Operating Income", companycode);
		jsonRsArray.add(18, jsonObjOP);

		jsonObj = jsonConbineRatio(jsonObjOP, jsonObjTBV, "in % of Total Business Volume", companycode);
		...
		jsonObjNOP = getResult(stmt, companycode,
				...
				"Non Operating Income", currency, Fiscal_Year, Posting_period, -1);
		jsonRsArray.add(24, jsonObjNOP);

		jsonObj = getRatioTBV(stmt, stmtTBV, companycode,
				"'Monetary Corrections','Exchange Gains/Losses','Interest Income / Expenses','Other Income / Expenses'",
				"in % of Total Business Volume", currency, Fiscal_Year, Posting_period, 1);
		jsonRsArray.add(25, jsonObj);

		jsonObjIBT = jsonConbinePlus(jsonObjOP, jsonObjNOP, "Income before Taxes", companycode);
		jsonRsArray.add(26, jsonObjIBT);

		jsonObj = jsonConbineRatio(jsonObjIBT, jsonObjTBV, "in % of Total Business Volume", companycode);
	...
	public static JSONArray OpeartingCosts(String Companies, String currency, String Fiscal_Year, String Posting_period)
			throws SQLException {
		String[] companycode = Companies.split(",");
		JSONObject jsonObj = new JSONObject();
		...
		jsonObj = getResult(stmt, companycode, "'Productive Wages'", "Productive Wages", currency, Fiscal_Year,
				Posting_period, 1);
		jsonRsArray.add(0, jsonObj);

		jsonObj = getResult(stmt, companycode, "'Unproductive Wages'", "Unproductive Wages", currency, Fiscal_Year,
				Posting_period, 1);
		jsonRsArray.add(1, jsonObj);

		jsonObj = getResult(stmt, companycode, "'Overtime Premium'", "Overtime Premium", currency, Fiscal_Year,
				Posting_period, 1);
		jsonRsArray.add(2, jsonObj);
		...
		jsonObj = getResult(stmt, companycode,
				...
				"Total Wages", currency, Fiscal_Year, Posting_period, 1);
		...
		jsonObj = getResult(stmt, companycode, "'Salaries'", "Salaries", currency, Fiscal_Year, Posting_period, 1);
		jsonRsArray.add(6, jsonObj);

		jsonObj = getResult(stmt, companycode, "'Overtime'", "Overtime", currency, Fiscal_Year, Posting_period, 1);
		jsonRsArray.add(7, jsonObj);
		...
		jsonObj = getResult(stmt, companycode,
				...
				"Total Personnel Costs", currency, Fiscal_Year, Posting_period, 1);
		jsonRsArray.add(11, jsonObj);
		...
		jsonObj = getResult(stmt, companycode, "'Consumables'", "Consumables", currency, Fiscal_Year, Posting_period,
				1);
		jsonRsArray.add(13, jsonObj);

		jsonObj = getResult(stmt, companycode, "'Energy'", "Energy", currency, Fiscal_Year, Posting_period, 1);
		jsonRsArray.add(14, jsonObj);
		...
		jsonObj = getResult(stmt, companycode, "'Other Depreciation'", "Other Depreciation", currency, Fiscal_Year,
				Posting_period, 1);
		...
		jsonObj = getResult(stmt, companycode, "'Interest Costs'", "Interest Costs", currency, Fiscal_Year,
				Posting_period, 1);
		jsonRsArray.add(20, jsonObj);

		jsonObj = getResult(stmt, companycode, "'Taxes/Duties'", "Taxes/Duties", currency, Fiscal_Year, Posting_period,
				1);
		jsonRsArray.add(21, jsonObj);

		jsonObj = getResult(stmt, companycode, "'Insurances'", "Insurances", currency, Fiscal_Year, Posting_period, 1);
		jsonRsArray.add(22, jsonObj);
		...
		jsonObj = getResult(stmt, companycode, "'Legal/Audit'", "Legal/Audit", currency, Fiscal_Year, Posting_period,
				1);
		jsonRsArray.add(25, jsonObj);

		jsonObj = getResult(stmt, companycode, "'Airfreight'", "Airfreight", currency, Fiscal_Year, Posting_period, 1);
		jsonRsArray.add(26, jsonObj);

		jsonObj = getResult(stmt, companycode, "'Surface Freight'", "Surface Freight", currency, Fiscal_Year,
				Posting_period, 1);
		jsonRsArray.add(27, jsonObj);

		jsonObj = getResult(stmt, companycode, "'Canteen'", "Canteen", currency, Fiscal_Year, Posting_period, 1);
		jsonRsArray.add(28, jsonObj);

		jsonObj = getResult(stmt, companycode, "'Royalties'", "Royalties", currency, Fiscal_Year, Posting_period, 1);
		jsonRsArray.add(29, jsonObj);

		jsonObj = getResult(stmt, companycode, "'GCSP'", "GCSP", currency, Fiscal_Year, Posting_period, 1);
		jsonRsArray.add(30, jsonObj);

		jsonObj = getResult(stmt, companycode, "'Other Costs'", "Other Costs", currency, Fiscal_Year, Posting_period,
				1);
		...
		jsonObj = getResult(stmt, companycode,
				...
				"Total Other Costs", currency, Fiscal_Year, Posting_period, 1);
		...
		jsonObjTOC = getResult(stmt, companycode,
				...
				"Total Operating Costs", currency, Fiscal_Year, Posting_period, 1);
		...
		jsonObj = getPLstructure(stmt, companycode,
				...
				"PL", currency, Fiscal_Year, Posting_period, 1);
		jsonObj = jsonConbine(jsonObjTOC, jsonObj, "Check PL_Structure", companycode);
	...
	public static JSONArray BalanceSheet(String Companies, String currency, String Fiscal_Year, String Posting_period)
			throws SQLException {
		String[] companycode = Companies.split(",");
		JSONObject jsonObj = new JSONObject();
		...
		jsonObj = getBalance(stmt, companycode, "'Land/Building'", "Land/Building", currency, Fiscal_Year,
				Posting_period, 1);
		jsonRsArray.add(0, jsonObj);
		...
		jsonObj = getBalance(stmt, companycode, "'Tools/Devices'", "Tools/Devices", currency, Fiscal_Year,
				Posting_period, 1);
		jsonRsArray.add(2, jsonObj);

		jsonObj = getBalance(stmt, companycode, "'Other Fixed Assets'", "Other Fixed Assets", currency, Fiscal_Year,
				Posting_period, 1);
		jsonRsArray.add(3, jsonObj);
		...
		jsonObj = getBalance(stmt, companycode, "'Rawmaterial/Parts'", "Rawmaterial/Parts", currency, Fiscal_Year,
				Posting_period, 1);
		jsonRsArray.add(5, jsonObj);

		jsonObj = getBalance(stmt, companycode, "'WiP/FG'", "WiP/FG", currency, Fiscal_Year, Posting_period, 1);
		jsonRsArray.add(6, jsonObj);
		...
		jsonObj = getBalance(stmt, companycode, "'Group Receivables'", "Group Receivables", currency, Fiscal_Year,
				Posting_period, 1);
		jsonRsArray.add(11, jsonObj);
		...
		jsonObj = getBalance(stmt, companycode,
				...
				"Current Assets", currency, Fiscal_Year, Posting_period, 1);
		jsonRsArray.add(15, jsonObj);
		...
		jsonAS = getBalance(stmt, companycode,
				...
				"Total Assets", currency, Fiscal_Year, Posting_period, 1);
		jsonRsArray.add(16, jsonAS);

		jsonObj = getBalance(stmt, companycode, "'Share Capital'", "Share Capital", currency, Fiscal_Year,
				Posting_period, -1);
		jsonRsArray.add(17, jsonObj);

		jsonObj = getBalance(stmt, companycode, "'Capital Reserve'", "Capital Reserve", currency, Fiscal_Year,
				Posting_period, -1);
		jsonRsArray.add(18, jsonObj);
		...
		jsonObj = getBalance(stmt, companycode,
				"'Share Capital','Capital Reserve','Profit/Loss previous years','Profit/Loss','Direct Material','Engineering Cost Depreciation','Interest Costs','REVENUES','Other Costs','Consumables','Productive Wages','Overtime Premium','Other Fringe Benefits Wages','Unproductive Wages','Salaries','Other Fringe Benefits','Canteen','Energy','Repairwork (external)','Taxes/Duties','Leasing/Depreciation (Build.)','Other Depreciation','Travel and Subsistance','Other Leasing Costs','Surface Freight','Airfreight','Other Capitalized Costs','Change in Stockvalue','Other Income / Expenses','Exchange Gains/Losses','Interest Income / Expenses','Legal/Audit','Insurances','Telephone/Telex/Telefax/Mail'",
				"Equity Capital", currency, Fiscal_Year, Posting_period, -1);
		jsonRsArray.add(21, jsonObj);
		...
		jsonObj = getBalance(stmt, companycode, "'LK-Loan'", "LK-Loan", currency, Fiscal_Year, Posting_period, -1);
		jsonRsArray.add(24, jsonObj);

		jsonObj = getBalance(stmt, companycode, "'Provisions for Retirements','Longterm Bank Loans','LK-Loan'",
				"Longterm Liabilities", currency, Fiscal_Year, Posting_period, -1);
		jsonRsArray.add(25, jsonObj);

		jsonObj = getBalance(stmt, companycode, "'Accounts Payables'", "Accounts Payables", currency, Fiscal_Year,
				Posting_period, -1);
		jsonRsArray.add(26, jsonObj);

		jsonObj = getBalance(stmt, companycode, "'Group Payables'", "Group Payables", currency, Fiscal_Year,
				Posting_period, -1);
		jsonRsArray.add(27, jsonObj);

		jsonObj = getBalance(stmt, companycode, "'Clearing Payables'", "Clearing Payables", currency, Fiscal_Year,
				Posting_period, -1);
		jsonRsArray.add(28, jsonObj);
		...
		jsonObj = getBalance(stmt, companycode,
				...
				"Shortterm Liabilities", currency, Fiscal_Year, Posting_period, -1);
		jsonRsArray.add(32, jsonObj);
		...
		jsonLL = getBalance(stmt, companycode,
				...
				"Total Equity and Liabilities", currency, Fiscal_Year, Posting_period, -1);
		jsonRsArray.add(33, jsonLL);

		jsonObj = jsonConbine(jsonAS, jsonLL, "Check Balance", companycode);
		...
		jsonEngineering = getInvestment(stmt, companycode, "'Invest Engineering Services'",
				"Invest Engineering Services", currency, Fiscal_Year, Posting_period, 1);
		...
		jsonMachineryIC = getInvestment(stmt, companycode, "'Invest Machinery/Equipment IC'",
				"Invest Machinery/Equipment IC", currency, Fiscal_Year, Posting_period, 1);
		...
		jsonEngineeringIC = getInvestment(stmt, companycode, "'Invest Engineering Services IC'",
				"Invest Engineering Services IC", currency, Fiscal_Year, Posting_period, 1);
		...
		jsonObj = jsonConbine(jsonLand, jsonLandIC, "Invest Land/Building 3rd", companycode);
		jsonRsArray.add(45, jsonObj);

		jsonObj = jsonConbine(jsonMachinery, jsonMachineryIC, "Invest Machinery/Equipment 3rd", companycode);
		jsonRsArray.add(46, jsonObj);

		jsonObj = jsonConbine(jsonTools, jsonToolsIC, "Invest Tools/Devices 3rd", companycode);
		jsonRsArray.add(47, jsonObj);

		jsonObj = jsonConbine(jsonEngineering, jsonEngineeringIC, "Invest Engineering Services 3rd", companycode);
		jsonRsArray.add(48, jsonObj);

		jsonObj = jsonConbine(jsonOther, jsonOtherIC, "Invest Other Fixed Assets 3rd", companycode);
		...
		jsonMachineryRetirement = getInvestment(stmt, companycode, "'Retirement Machinery/Equipment'",
				"Retirement Machinery/Equipment", currency, Fiscal_Year, Posting_period, 1);
		...
		jsonEngineeringRetirement = getInvestment(stmt, companycode, "'Retirement Engineering Services'",
				"Retirement Engineering Services", currency, Fiscal_Year, Posting_period, 1);
		...
		jsonOtherRetirement = getInvestment(stmt, companycode, "'Retirement Other Fixed Assets'",
				"Retirement Other Fixed Assets", currency, Fiscal_Year, Posting_period, 1);
		jsonRsArray.add(54, jsonOtherRetirement);

		jsonLandICRetirement = getInvestment(stmt, companycode, "'Retirement Land/Building IC'",
				"Retirement Land/Building IC", currency, Fiscal_Year, Posting_period, 1);
		...
		jsonMachineryICRetirement = getInvestment(stmt, companycode, "'Retirement Machinery/Equipment IC'",
				"Retirement Machinery/Equipment IC", currency, Fiscal_Year, Posting_period, 1);
		...
		jsonToolsICRetirement = getInvestment(stmt, companycode, "'Retirement Tools/Devices IC'",
				"Retirement Tools/Devices IC", currency, Fiscal_Year, Posting_period, 1);
		...
		jsonEngineeringICRetirement = getInvestment(stmt, companycode, "'Retirement Engineering Services IC'",
				"Retirement Engineering Services IC", currency, Fiscal_Year, Posting_period, 1);
		...
		jsonOtherICRetirement = getInvestment(stmt, companycode, "'Retirement Other Fixed Assets IC'",
				"Retirement Other Fixed Assets IC", currency, Fiscal_Year, Posting_period, 1);
		jsonRsArray.add(59, jsonOtherICRetirement);

		jsonObj = jsonConbine(jsonLandRetirement, jsonLandICRetirement, "Retirement Land/Building 3rd", companycode);
		...
		jsonObj = jsonConbine(jsonToolsRetirement, jsonToolsICRetirement, "Retirement Tools/Devices 3rd", companycode);
		jsonRsArray.add(62, jsonObj);

		jsonObj = jsonConbine(jsonEngineeringRetirement, jsonEngineeringICRetirement,
				"Retirement Engineering Services 3rd", companycode);
		...
		jsonCAPITAL_EXPENDITURES = getInvestment(stmt, companycode,
				...
				"CAPITAL EXPENDITURES", currency, Fiscal_Year, Posting_period, 1);
		...
		jsonCheck_Investment = getAssetBalance(stmt, companycode, "", "Check Investment", currency, Fiscal_Year,
				Posting_period, 1);
		jsonObj = jsonConbine(jsonCAPITAL_EXPENDITURES, jsonTOTAL_DEPRECIATION, "Check Investment", companycode);
		jsonObj = jsonConbine(jsonObj, jsonCheck_Investment, "Check Investment", companycode);
	...
	public static JSONObject getResult(Statement stmt, String[] CompanyCode, String IRT_Structure,
			String IRT_Structure_Name, String currency, String Fiscal_Year, String Posting_period, int denominatorSign)
			throws SQLException {
		JSONObject jsonObj = new JSONObject();
		...
		String CompanyCodeCondition = "";
		for (int i = 0; i < CompanyCode.length; i++) {
			if (i < CompanyCode.length - 1) {
				CompanyCodeCondition = CompanyCodeCondition + "'" + CompanyCode[i] + "' OR `Company Code` = ";
			} else {
				CompanyCodeCondition = CompanyCodeCondition + "'" + CompanyCode[i] + "'";
			}
		}
		for (int i = 0; i < CompanyCode.length + 1; i++) {
			if (i < CompanyCode.length) {
				String sql_getResult = "SELECT `Company Code`, SUM(`Balance LC`) / 1000 AS 'SUM of Balance'  FROM report_irt_basic_info  WHERE (`IRT Structure` = "
						...
						+ "' AND `Posting period` = '" + Posting_period + "' GROUP BY `Company Code`, `Currency`";

				ResultSet rs = stmt.executeQuery(sql_getResult);
				while (rs.next()) {
					jsonObj.put(CompanyCode[i].toString(), df.format(rs.getDouble("SUM of Balance") / denominatorSign));
				}
			} else {
				String sql_getResult = "SELECT SUM(`Balance LC`) / 1000 AS 'SUM of Balance'  FROM report_irt_basic_info  WHERE (`IRT Structure` = "
						+ IRT_Structure + ") AND (`Company Code` = " + CompanyCodeCondition + ") AND `Currency` = '"
						+ currency + "' AND `Fiscal Year` = '" + Fiscal_Year + "' AND `Posting period` = '"
		...
		for (int i = 0; i < CompanyCode.length + 1; i++) {
			if (i < CompanyCode.length) {
				...
				String sql_getResultTBV = "SELECT `Company Code`, SUM(`Balance LC`) / 1000 AS 'SUM of Balance'  FROM report_irt_basic_info  WHERE (`IRT Structure` = 'REVENUES' OR `IRT Structure` = 'Change in Stockvalue' OR `IRT Structure` = 'Other Capitalized Costs') AND `Currency` = '"
						+ currency + "' AND `Company Code` = '" + CompanyCode[i].toString() + "' AND `Fiscal Year` = '"
						+ Fiscal_Year + "' AND `Posting period` = '" + Posting_period + "' GROUP BY  `Currency`";
				...
				jsonObj.put(CompanyCode[i].toString(), df.format(percentage / denominatorSign));
			} else {
				String sql_getResult = "SELECT SUM(`Balance LC`) / 1000 AS 'SUM of Balance'  FROM report_irt_basic_info  WHERE (`IRT Structure` = "
						+ IRT_Structure + ") AND (`Company Code` = " + CompanyCodeCondition + ") AND `Currency` = '"
						+ currency + "' AND `Fiscal Year` = '" + Fiscal_Year + "' AND `Posting period` = '"
				...
				String sql_getResultTBV = "SELECT  SUM(`Balance LC`) / 1000 AS 'SUM of Balance'  FROM report_irt_basic_info  WHERE (`IRT Structure` = 'REVENUES' OR `IRT Structure` = 'Change in Stockvalue' OR `IRT Structure` = 'Other Capitalized Costs') AND (`Company Code` = "
						+ CompanyCodeCondition + ") AND `Currency` = '" + currency + "' AND `Fiscal Year` = '"
						+ Fiscal_Year + "' AND `Posting period` = '" + Posting_period + "' GROUP BY `Currency`";
	...
	public static JSONObject getPLstructure(Statement stmt, String[] CompanyCode, String IRT_Structure,
		...
		for (int i = 0; i < CompanyCode.length; i++) {
			if (i < CompanyCode.length - 1) {
				CompanyCodeCondition = CompanyCodeCondition + "'" + CompanyCode[i] + "' OR `CoCd` = ";
			} else {
				CompanyCodeCondition = CompanyCodeCondition + "'" + CompanyCode[i] + "'";
			}
		}
		for (int i = 0; i < CompanyCode.length + 1; i++) {
			if (i < CompanyCode.length) {
				String sql_getResult = "SELECT `CoCd`, SUM(`In company code currency`) / 1000 AS 'SUM of In company code currency'  FROM report_irt_basic_info_plstructure  WHERE (`P&L Structure` = "
						+ IRT_Structure + ") AND `CoCd` = '" + CompanyCode[i].toString() + "' AND `Local Crcy` = '"
				...
				String sql_getResult = "SELECT SUM(`In company code currency`) / 1000 AS 'SUM of In company code currency'  FROM report_irt_basic_info_plstructure  WHERE (`P&L Structure` = "
						+ IRT_Structure + ") AND (`CoCd` = " + CompanyCodeCondition + ") AND `Local Crcy` = '"
						+ currency + "' AND `Year` = '" + Fiscal_Year + "' AND `Period` = '" + Posting_period
						+ "' GROUP BY `Local Crcy`";
		...
		for (int i = 0; i < CompanyCode.length + 1; i++) {
			if (i < CompanyCode.length) {
				String sql_getResult = "SELECT `Company Code`, SUM(`Balance LC`) / 1000 AS 'SUM of Balance LC'  FROM basic_info_investment_check  WHERE  `Company Code` = '"
						+ CompanyCode[i].toString() + "' AND `Currency` = '" + currency + "' AND `Fiscal Year` = '"
						+ Fiscal_Year + "' AND `Posting period` = '" + Posting_period
						+ "' GROUP BY `Company Code`, `Currency`";

				ResultSet rs = stmt.executeQuery(sql_getResult);
				while (rs.next()) {
					jsonObj.put(CompanyCode[i].toString(),
							df.format(rs.getDouble("SUM of Balance LC") / denominatorSign));
				}
			} else {
		...
		for (int i = 0; i < CompanyCode.length + 1; i++) {
			if (i < CompanyCode.length) {
				String sql_getResult = "SELECT `CoCd`, SUM(`currectAcquisition`) / 1000 AS 'SUM of currectAcquisition'  FROM report_irt_basic_info_investment  WHERE (`IRT_Structure` = "
						+ IRT_Structure + ") AND `CoCd` = '" + CompanyCode[i].toString() + "' AND `Crcy` = '" + currency
				...
				String sql_getResult = "SELECT SUM(`currectAcquisition`) / 1000 AS 'SUM of currectAcquisition'  FROM report_irt_basic_info_investment  WHERE (`IRT_Structure` = "
						+ IRT_Structure + ") AND (`CoCd` = " + CompanyCodeCondition + ") AND `Crcy` = '" + currency
						+ "' AND `Year` = '" + Fiscal_Year + "' AND `Period` = '" + Posting_period
						+ "' GROUP BY `Crcy`";
	...
	public static JSONObject jsonConbine(JSONObject json1, JSONObject json2, String IRT_Structure_Name,
		...
		for (int i = 0; i < CompanyCode.length; i++) {
			list.add(CompanyCode[i]);
		}
		list.add("Total");
		JSONObject jsonObj = new JSONObject();
		jsonObj.put("Structure", IRT_Structure_Name);
		for (int i = 0; i < list.size(); i++) {
			if ((json1.has((String) list.get(i))) && (json2.has((String) list.get(i)))) {
				jsonObj.put(list.get(i),
						Double.valueOf(json1.getDouble((String) list.get(i)) - json2.getDouble((String) list.get(i))));
			}
		}
		return jsonObj;
	}
	...
	public static JSONObject jsonConbineRatio(JSONObject json1, JSONObject json2, String IRT_Structure_Name,
		...
		for (int i = 0; i < list.size(); i++) {
			if ((json1.has((String) list.get(i))) && (json2.has((String) list.get(i)))) {
				jsonObj.put(list.get(i),
						df.format(json1.getDouble((String) list.get(i)) / json2.getDouble((String) list.get(i))));
			}
		}
		return jsonObj;
	}
